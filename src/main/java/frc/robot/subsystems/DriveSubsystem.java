...
public class DriveSubsystem extends SubsystemBase {
  private final WPI_TalonSRX frontLeft = new WPI_TalonSRX(DriveConstants.FRONT_LEFT_MOTOR_PORT);
  private final WPI_TalonSRX rearLeft = new WPI_TalonSRX(DriveConstants.REAR_LEFT_MOTOR_PORT);
  private final WPI_TalonSRX frontRight = new WPI_TalonSRX(DriveConstants.FRONT_RIGHT_MOTOR_PORT);
  private final WPI_TalonSRX rearRight = new WPI_TalonSRX(DriveConstants.REAR_RIGHT_MOTOR_PORT);
